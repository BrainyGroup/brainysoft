...
<div class="col-md-6">
    <div class="card">
        ...
        <div class="card-body">
            ...
            {{ Form::bsText('balance',$statutory_balance,['placeholder' => __('messages.balance'), 'label' => __('messages.balance')]) }}

            {{ Form::bsText('paid',$statutory_balance,['placeholder' => __('messages.paid'), 'label' => __('messages.paid')]) }}
