        ...
        <div class="col-md-9">
            <div class="tab-content">
                <div class="tab-pane active" id="general">
                    @include('basic_settings.includes.general')
                </div>
                <div class="tab-pane fade" id="site-logo">
                    @include('basic_settings.includes.logo')
                </div>
                <div class="tab-pane fade" id="footer-seo">
                    @include('basic_settings.includes.footer_seo')
                </div>
                <div class="tab-pane fade" id="social-links">
                    @include('basic_settings.includes.social_links')
                </div>
                <div class="tab-pane fade" id="analytics">
                    @include('basic_settings.includes.analytics')
                </div>
                <div class="tab-pane fade" id="payments">
                    @include('basic_settings.includes.payments')
                </div>
            </div>
        </div>
    </div>
