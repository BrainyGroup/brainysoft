...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
                    ...
                    {{ Form::bsText('employee_ratio', $statutory->employee_ratio,['placeholder' => 'Enter employee ratio']) }}

                    {{ Form::bsText('employer_ratio', $statutory->employer_ratio,['placeholder' => 'Enter employer ratio']) }}

                    {{ Form::bsDate('due_date', $statutory->due_date) }}
